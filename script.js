const translations = {
  fr: {
    ...
    member2_bio: "Bio",
    member3_name: "Membre 3",
    member3_role: "Secrétaire Général",
    member3_bio: "Bio",
    member4_name: "Membre 4",
    member4_role: "Responsable Communication",
    member4_bio: "Bio",
    member5_name: "Membre 5",
    member5_role: "Adjointe au responsable RH",
    member5_bio: "Bio",
    member6_name: "Membre 6",
    member6_role: "Responsable des réseaux sociaux",
    member6_bio: "Bio",
    member7_name: "Membre 7",
    member7_role: "Responsable RH",
    member7_bio: "Bio",
    member8_name: "Membre 8",
  ...
  en: {
    ...
    member4_bio: "Bio",
    member5_name: "Member 5",
    member5_role: "HR Assistant",
    member5_bio: "Bio",
    member6_name: "Member 6",
    member6_role: "Social Media Manager",
    member6_bio: "Bio",
    member7_name: "Member 7",
    member7_role: "HR Manager",
    member7_bio: "Bio",
    member8_name: "Member 8",
...
function handleLogin(event) {
    ...
    const validUsers = [
        { 
            email: 'jalalelyandouzi2@gmail.com', 
            password: 'Elynd@12',
            name: 'Jalal El Yandouzi'
        },
        { 
            email: 'mohamed.elyaouti.fpn23@ump.ac.ma', 
            password: 'Elyaoutimed@12',
            name: 'Mohamed El Yaouti'
        },
        { 
            email: 'mohammed.bouhdifi.fpn23@ump.ac.ma', 
            password: 'Bouhdifi@2005',
            name: 'Mohammed Bouhdifi'
        },
        { 
            email: 'taoufiq.elboutaibi.fpn23@ump.ac.ma', 
            password: 'Taoufiq@2005',
            name: 'Taoufiq El Boutaibi'
        },
        { 
        ...
        { 
            ...
            password: 'Nouhayla@2006',
            name: 'Nouhayla El Yaâkoubi'
        },
        { 
            email: 'Kaouthar.amousi.fpn24@ump.ac.ma', 
            password: 'Amousi@2006',
            name: 'Kaouthar Amousi'
        },
    ];
